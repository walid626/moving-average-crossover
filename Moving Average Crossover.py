...
if __name__ == '__main__':
    ...
    while True:
        ...
        #calculating last candle close and simple moving average and checking for trading signals
        ...
        if direction == 'buy':
            ...
            for pos in mt5.positions_get():
                if pos.type == 1: #represents sell order
            ...
            for pos in mt5.positions_get():
                if pos.type == 0: #represents buy order
                    close_order(pos.ticket)
